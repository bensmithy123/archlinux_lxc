...
`libva-intel-driver`: Intel legacy VAAPI support (10th Gen and older)  - sudo apt install intel-media-va-driver-non-free   (HAS TO BE NON FREE, free will not encode)
